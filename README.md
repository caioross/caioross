...
const caio = {
  ...
  stack: ["TypeScript", "Python", "Kotlin", "C++", "C#", "Next.js", "Unity", "Unreal"],
  filosofia: "Privacidade por padrão! se dá pra rodar offline, roda offline.",
  ensina: "programação e IA — instrutor",
  offline: "surf no fim de semana 🏄",
  squad: ["eu", "meu gato 🐈‍⬛"],
};
```
...
![](https://skillicons.dev/icons?i=ts,js,py,kotlin,cpp,cs,react,nextjs,nodejs,tailwind,vite,threejs,unity,unreal&perline=14)
![](https://skillicons.dev/icons?i=pytorch,tensorflow,supabase,postgres,redis,docker,aws,gcp,cloudflare,linux,git,githubactions,vercel,blender&perline=14)
...
|---|---|:---:|:---:|
| **Clippy** | Companheiro de desktop com IA 100% local — wake word + STT + LLM + TTS | [⟨code⟩](https://github.com/caioross/Clippy) | [🌐](https://clippy-beige.vercel.app) |
| **Laguna Translate** | Tradução de voz PT↔EN em tempo real, 100% local | [⟨code⟩](https://github.com/caioross/Laguna_Translate) | [🌐](https://lagunatranslate.vercel.app) |
| **Transcribid** | Grava mic + áudio do sistema e transcreve localmente (Windows) | [⟨code⟩](https://github.com/caioross/Transcribid) | [🌐](https://transcribid.vercel.app) |
| **3draza** | Transforma imagem em modelo 3D texturizado, 100% local | [⟨code⟩](https://github.com/caioross/3draza) | [🌐](https://3draza.vercel.app) |
...
| **Dublador Astral Forge** | Dublagem PT-BR + EN das 135 cartas de *Astral Forge* (Qwen2.5-VL + Chatterbox) | 🔒 | [🌐](https://dublador-astral-forge.vercel.app) |
| **Animador de Imagens** | Anima as artes de *Astral Forge* em vídeos em loop (LTX-Video) | 🔒 | [🌐](https://animador-imagens-astral-forge.vercel.app) |
| **Gerenciador de Módulos** | Cataloga os módulos .glb e exporta o catálogo de *88 Starlings* (Three.js) | 🔒 | [🌐](https://gerenciador-modulos-88starlings.vercel.app) |
...
| Projeto | O que é | Code | Live |
|---|---|:---:|:---:|
| **cudernalis** | Simulador 3D dos orbitais atômicos dos 118 elementos (física real) | [⟨code⟩](https://github.com/caioross/cudernalis) | [🌐](https://cudernalis.vercel.app) |
| **CodeOrigins** | Mapa estelar 3D das linguagens de programação e suas origens | [⟨code⟩](https://github.com/caioross/CodeOrigins) | [🌐](https://www.codeorigins.space) |
| **CatalyticAtlas** | Explorador 3D de enzimas: estrutura, mecanismo e dinâmica | [⟨code⟩](https://github.com/caioross/CatalyticAtlasEDE) | [🌐](https://catalytic-atlas.vercel.app) |
| **DNAExplorer** | Suba seu DNA bruto e explore o genoma em 3D (100% client-side) | [⟨code⟩](https://github.com/caioross/DNAExplorer) | [🌐](https://dna-explorer-eta.vercel.app) |
...
| Projeto | O que é | Code | Live |
|---|---|:---:|:---:|
| **OmniCube** | Multímetro de bancada com IA — sem botões, diagnóstico por conversa | 🔒 | [🌐](https://omnicube.vercel.app) |
| **Print&Pint** | Biblioteca de modelos 3D para impressão (fluxo Meshy → Blender → Bambu) | 🔒 | [🌐](https://printpint.vercel.app) |
| **War Atlas** | Board game de conquista mundial com globo escultural e o titã Atlas | 🔒 | [🌐](https://waratlas-ten.vercel.app) |
...
1. 🗣 Commented on [#7](https://github.com/caioross/NostalgiaGPT/issues/7#issuecomment-5154197826) in [caioross/NostalgiaGPT](https://github.com/caioross/NostalgiaGPT)
2. 🎉 Merged PR [#69](https://github.com/caioross/NostalgiaGPT/pull/69) in [caioross/NostalgiaGPT](https://github.com/caioross/NostalgiaGPT)
3. 🔒 Closed issue [#67](https://github.com/caioross/NostalgiaGPT/issues/67) in [caioross/NostalgiaGPT](https://github.com/caioross/NostalgiaGPT)
4. 🗣 Commented on [#69](https://github.com/caioross/NostalgiaGPT/pull/69#issuecomment-5154194803) in [caioross/NostalgiaGPT](https://github.com/caioross/NostalgiaGPT)
5. ℹ️ Labeled issue [#23](https://github.com/caioross/nebula/issues/23) in [caioross/nebula](https://github.com/caioross/nebula)
6. ❗ Opened issue [#23](https://github.com/caioross/nebula/issues/23) in [caioross/nebula](https://github.com/caioross/nebula)
7. 🗣 Commented on [#1](https://github.com/caioross/PromptMeter/issues/1#issuecomment-5154066652) in [caioross/PromptMeter](https://github.com/caioross/PromptMeter)
8. 🎉 Merged PR [#65](https://github.com/caioross/PromptMeter/pull/65) in [caioross/PromptMeter](https://github.com/caioross/PromptMeter)
...
<img height="170" src="https://streak-stats.demolab.com/?user=caioross&hide_border=true&background=0f0c29&ring=24c6dc&fire=8b5cf6&currStreakLabel=24c6dc&sideLabels=c9d1d9&dates=8b949e"/>
...
<img width="98%" alt="Grafo 3D de contribuições" src="https://raw.githubusercontent.com/caioross/caioross/3d/profile-night-rainbow.svg"/>
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:24c6dc,60:302b63,100:0f0c29&height=120&section=footer&text=eu%20%2B%20meu%20gato%20contra%20o%20mundo%20%F0%9F%90%88%E2%80%8D%E2%AC%9B&fontColor=ffffff&fontSize=20&fontAlignY=70" width="100%"/>
